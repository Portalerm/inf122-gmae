...
//         RaidMob entity = findEntity(newRow, newCol);
...
//     private void handleEntityInteraction(RaidPlayer player, RaidMob entity) {
...
//                                 + entity.getAttackPower() + " damage! (" + pName + " HP: " + player.getHp() + ")");
//                     }
//                 }
//                 if (!entity.isAlive()) {
...
//     private RaidMob findEntity(int row, int col) {
//         for (RaidMob e : entities) {
