public class EscortPlayer {
    ...
    public void setEscort(boolean bool) { escortingNPC = bool; }
    public boolean isEscortingNPC() { return escortingNPC; }
    public int getHp() { return hp; }
    public int getMaxHp() { return maxHp; }
    public int getAttackPower() { return attackPower; }
    public boolean isAlive() { return alive; }
    public int getPlayerNumber() { return playerNumber; }
    public void addNPC(Npc npc) { escortedNPC = npc; }
    public void removeNPC() { escortedNPC = null;}
